...
app
  .factory("ngLangcodeFactory", function() {
    var name_2_local,
      name_2_alpha1,
      name_2_alpha2,
      name_2_alpha2t,
      ...
      return function(input, input_type = "name", output_type = "alpha1") {
        ...
        switch (input_type) {
          ...
          case "alpha3":
            ...
            break;
          default:
            _lang_name_ = ngLangcodeFactory.langExist(input)
              ? input
              : _lang_name_;
            break;
        }
        ...
        if (_lang_name_ === undefined) {
          console.warn(
            input + " doesn't exist in the list of language, return input"
          );
          return input;
        }
